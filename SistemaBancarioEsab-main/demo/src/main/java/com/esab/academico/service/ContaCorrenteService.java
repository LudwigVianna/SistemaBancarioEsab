package com.esab.academico.service;
...
import com.esab.academico.dto.OperacaoDTO;
import com.esab.academico.dto.OperacaoRealizadaDTO;
import com.esab.academico.dto.TransferenciaDTO;
import com.esab.academico.model.ContaCorrente;
import com.esab.academico.model.Extrato;
import com.esab.academico.model.OperacaoTipo;
import com.esab.academico.repository.ClienteRepository;
import com.esab.academico.repository.ContaCorrenteRepository;
...
public class ContaCorrenteService {
	...
	public void transferencia(TransferenciaDTO transf) throws Exception {
		...
		ContaCorrente cc = contaRepository.findById(transf.getIdConta()).orElse(null);
	...
	public ContaCorrente buscarConta(String num) {
		...
		ContaCorrente conta = contaRepository.findById(id).orElse(null);
	...
	public OperacaoRealizadaDTO operacao(OperacaoDTO dto) throws Exception {
		ContaCorrente cc = contaRepository.findById(dto.getContaId()).orElse(null);
